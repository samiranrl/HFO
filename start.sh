...
stdbuf -oL ./bin/HFO  --offense-agents 3 --defense-npcs 2 --headless --no-logging --trials 10000 --seed $1 --port $1 >> test$1.txt &
sleep 5
( cd example/sarsa_offense && ./high_level_sarsa_agent --learnRate 0 --eps 0 --numAgents 3 --numEpisodes 10000 --basePort $1 )
wait
